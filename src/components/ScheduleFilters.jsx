...
export const activeFilterCount = (filters) => Object.entries(filters).filter(([key, value]) => key === 'opponent' ? Boolean(value) : value !== 'all').length
export function ScheduleFilters({ games, filters, setFilters }) {
  ...
  return (<div className="filter-bar schedule-filter-bar">
